...
class AssistantMood {
  ...
  initialize() {
    ...
    // Adicionar este listener para compatibilidade com hideAssistant
    document.addEventListener("assistant:hidden", (event) => {
      console.log("[assistantMood] Assistente oculto, pausando animações");
      this.pauseAnimations();
    });

    // Adicionar listener para quando o assistente é mostrado novamente
    document.addEventListener("assistant:shown", (event) => {
      console.log("[assistantMood] Assistente mostrado, resumindo animações");
  ...
  pauseAnimations() {
    ...
    if (moodIcon) {
      moodIcon.style.animationPlayState = "paused";
    }
  }
  ...
  resumeAnimations() {
    ...
    const moodIcon = document.querySelector(".mood-icon");
    if (moodIcon) {
      moodIcon.style.animationPlayState = "running";
    }
  }
}
