...
import { messages } from "../assistant/messages/messages.js";
        ...
        <div class="toggle-switch" onclick="this.querySelector('input').click();">
          <input type="checkbox" id="voice-enabled-toggle" checked 
                 onchange="(function(e){
                   ...
                   import('./js/voice/voiceSystem.js').then(module => {
...
export function setupAssistantInteractions(onUserMessage) {
  ...
  if (languageSelect) {
    ...
    languageSelect.addEventListener("change", (e) => {
      ...
      import("../assistant/assistant.js").then((assistantModule) => {
  ...
  function updateMessagesContainerSize() {
    ...
    if (messageCount > 3) {
      ...
      if (messagesHeight > maxHeight) {
        ...
        assistantMessages.style.height = `${messagesHeight + 40}px`;
      }
    }
...
function appendMessage(sender, message) {
  ...
  setTimeout(() => {
    ...
    const emptyAreas = document.querySelectorAll(
      "#assistant-messages .messages-area:empty, #assistant-messages .navigation-instruction-area:empty"
    );
